...
public class HMoPagosAdapter {
    ...
    private static final String TAG = "HMoPagosAdapter";
    ...
    private static final String DATABASE_TABLE = "pago";
     ...
     */
    public HMoPagosAdapter(Context ctx) {
        this.mCtx = ctx;
    }
     ...
     */
    public HMoPagosAdapter open() throws SQLException {
     ...
     * 
     * @param mes the title of the note
     * @param diasreporte the body of the note
     * @param valorreporte
     * @param totalpagado
     * @param deuda
    ...
    public long createLectura(String mes, String diasreporte, String valorreporte, String totalpagado, String deuda) {
     ...
     */
    public boolean deleteLectura(long rowId) {
    ...
    public Cursor fetchAllPagos() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_MES,
     ...
     */
     ...
     public Cursor fetchLectura(long rowId) throws SQLException {
